...
DEFAULT_CONFIG = {
    ...
    'toolbar_Full': [
        ...
        ['Paragraph', 'Styles', 'Format', 'Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript', 'RemoveFormat'], ['Source'],
        ['Filer Image', 'Youtube', 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'Iframe'], ['NumberedList', 'BulletedList', 'Outdent', 'Indent', 'Blockquote',
        'CreateDiv', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock'], ['Link', 'Unlink', 'Anchor'],
        ['TextColor', 'BGColor'], ['Maximize', 'ShowBlocks'],
    ],
    'toolbar': 'Full',
    'height': 291,
    'extraPlugins': 'filerimage,youtube',
    'removePlugins': 'image',
    #'width': 835,
